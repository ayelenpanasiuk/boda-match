    ...
    <div className="screen items-center justify-between px-6 py-14">
      ...
      <div className="flex flex-col items-center text-center z-10 px-2">
        ...
        <p className="font-body text-white/55 text-base leading-relaxed mb-2 max-w-[17rem]">
          Swipeá entre los invitados y encontrá tu match 😉
        </p>

        <p className="font-script text-white/30 text-lg mb-9">
          Deslizá sin vergüenza.
        </p>
      ...
      <div className="w-full z-10 flex flex-col gap-3">
        <button
          className="btn-wine"
          onClick={() => navigate(me ? '/feed' : '/onboarding')}
        >
          Entrar a la fiesta 🎉
        </button>

        <p className="font-body text-white/20 text-xs text-center">
          Solo para invitados · A&amp;A · 26/09/2026
        </p>
      </div>
    </div>
  )
